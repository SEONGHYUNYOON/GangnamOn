...
const GangnamReactionTest = ({ onClose, user }) => {
     ...
     return (
          <div className="fixed inset-0 z-[70] bg-[#0A0A10] flex items-center justify-center p-4">
               ...
               <div className={`relative bg-gray-900/80 backdrop-blur-xl rounded-3xl p-6 md:p-10 border border-indigo-500/30 shadow-[0_0_80px_rgba(99,102,241,0.2)] max-w-6xl w-full flex flex-col lg:flex-row gap-10 items-center lg:items-stretch animate-in zoom-in-95 duration-500`}>
