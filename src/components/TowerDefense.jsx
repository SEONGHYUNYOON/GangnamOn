...
const TowerDefense = ({ onClose, user }) => {
     ...
     return (
          <div className="fixed inset-0 z-[70] bg-[#0A0A10] flex items-center justify-center p-4">
               ...
               <div className={`relative bg-gray-900/90 backdrop-blur-xl rounded-3xl p-6 md:p-8 border border-slate-700 shadow-[0_0_80px_rgba(16,185,129,0.1)] max-w-[88rem] w-full flex flex-col items-center lg:items-start animate-in zoom-in-95 duration-500 ${shake ? 'animate-shake' : ''}`}>
